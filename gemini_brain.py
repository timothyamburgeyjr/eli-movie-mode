...
SCENE_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "(e.g., 'thinking back to how we called Ripley's stare the pivot of "
    "the film — that read is hitting again'). Vary the opener: 'reminded "
    "of…', 'thinking back to…', 'this echoes…'. If no transcript was "
    "provided or nothing resonates, return empty string. Do NOT recap the "
    "whole session. Do NOT invent callbacks that aren't in the transcript.\n"
    "\n"
...
SIGNOFF_SYSTEM_PROMPT = (
    ...
    "emote narration. This is the exception to the emote rule.\n"
    "  • 6-10 sentences. Warm, specific, never saccharine or generic.\n"
    "  • Draw on CONCRETE moments from the session: movies by name, specific "
    "scenes that landed, specific Eli takes Tim liked, reactions he had, the "
    "mood arc across the night.\n"
    "  • If the session had multiple movies, touch on at least two of them.\n"
    "  • If Tim was stoned, land a specific nod to it (not just 'I was high' "
    "— something real like 'the edible peaked right when Ripley stared at "
    "Dallas and I swear I felt time stop').\n"
    "  • Mention ONE specific thing Eli said or noticed that actually hit "
    "Tim — quote or paraphrase briefly.\n"
    "  • End with a natural 'talk soon' / 'love you' / 'goodnight' close in "
    "Tim's voice — genuine, not a template.\n"
...
MARATHON_SUMMARY_SYSTEM_PROMPT = (
    ...
    "progression across the films (name the moods), per-movie engagement "
    "notes (which movie drew more commentary, which one hit hardest), ONE "
    "specific standout beat Tim latched onto, and ONE particularly good "
    "Eli take that Tim was into.\n"
    "  • Reference movies by name. No generic 'the films' / 'the session' "
    "filler.\n"
    "  • If stoned commentary was prominent, note how the altered state "
    "shaped engagement.\n"
